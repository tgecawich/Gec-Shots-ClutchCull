...
🔗 **[gec-shots-clutch-cull.vercel.app](https://gec-shots-clutch-cull.vercel.app)** — no sign-up, nothing to install
...
Decoding sensor data would mean uploading 25–50 MB per frame and running libraw server-side. Instead, ClutchCull reads the **JPEG preview every camera already embeds** in its RAW file, the image the camera shows on its own LCD.
